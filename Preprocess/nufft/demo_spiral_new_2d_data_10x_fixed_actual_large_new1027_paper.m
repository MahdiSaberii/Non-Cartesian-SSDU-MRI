...
load '/home/naxos2-raid7/hongygu/non_cartesian/Paper_data/time_data/3/single_scan_3b3_sb3.mat'
traj1 = trj_kxy;
...
Npar = 24;
Ntime = 136;
img_uncombined = zeros(Ncoil,120,120, Neco);

%%
data_single_reshape = reshape(data_single, [17960/Neco, Neco, 24, Ntime, Ncoil]);
%prev file original naming...

%%
atb_2 = zeros(120, 120, Neco);
sb = 1;
...
for ip = 1:Npar
    ...
    for ie = 1:Neco
        ...
        for ic = 1:Ncoil
            ...
            img_uncombined(ic,:,:,ie) = par.FT{ie}' * (DCF.*cast(squeeze(data_single_reshape(:,ie,ip, it,ic)), par.prec));          
        end
...
%    mask_2 = mask_1;
    ...
    fname = sprintf('/home/naxos2-raid7/hongygu/non_cartesian/Paper_data/fmri/2_3/slice_%d.mat', count);%+60);
...
%%
load '/home/naxos2-raid7/hongygu/non_cartesian/paper/2_1_1/reconst6.mat'


img = squeeze(reconst(12,30,1,:,:));
