...
%%
load '/home/naxos2-raid7/hongygu/non_cartesian/spiral_fmri/DCF_modified_results/my_training/ssdu_0_5/new_run/fixed_data/large_testing/full_1027_ISMRM.mat'
traj1 = trj_kxy;
...
% 
Ncoil = size(data_full,5); %different
Npar = 24;
img_uncombined_full = zeros([[120,120], Ncoil, 6, Npar]);
data_full_reshaped = reshape(squeeze(data_full(:,:,:,3,:)), [2176, 6, 10, Npar, Ncoil]);
