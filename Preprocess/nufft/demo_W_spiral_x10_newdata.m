...
load('/home/naxos2-raid7/hongygu/non_cartesian/spiral_fmri/RawData/singleShot_sbj1_2D.mat')
...
for ie = 1:Neco
    par.FT{ie} = NUFFTDCF(trj_kxy(:,1,ie), ones(size((dc10x(:,ie)./max(max(dc10x(:,ie)))).^2)), shift, [240, 240]);
end
