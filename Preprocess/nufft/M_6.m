...
%%
load('/home/naxos2-raid7/hongygu/non_cartesian/Paper_data/masks/mask_paper_6_1.mat')
training_all(1, :) = training;
validation_all(1, :) = validation;

load('/home/naxos2-raid7/hongygu/non_cartesian/Paper_data/masks/mask_paper_6_2.mat')
training_all(2, :) = training;
validation_all(2, :) = validation;

load('/home/naxos2-raid7/hongygu/non_cartesian/Paper_data/masks/mask_paper_6_3.mat')
training_all(3, :) = training;
validation_all(3, :) = validation;

load('/home/naxos2-raid7/hongygu/non_cartesian/Paper_data/masks/mask_paper_6_4.mat')
training_all(4, :) = training;
validation_all(4, :) = validation;

load('/home/naxos2-raid7/hongygu/non_cartesian/Paper_data/masks/mask_paper_6_5.mat')
training_all(5, :) = training;
validation_all(5, :) = validation;

load('/home/naxos2-raid7/hongygu/non_cartesian/Paper_data/masks/mask_paper_6_6.mat')
training_all(6, :) = training;
validation_all(6, :) = validation;

load('/home/naxos2-raid7/hongygu/non_cartesian/Paper_data/masks/mask_paper_6_7.mat')
training_all(7, :) = training;
validation_all(7, :) = validation;

load('/home/naxos2-raid7/hongygu/non_cartesian/Paper_data/masks/mask_paper_6_8.mat')
training_all(8, :) = training;
validation_all(8, :) = validation;

load('/home/naxos2-raid7/hongygu/non_cartesian/Paper_data/masks/mask_paper_6_9.mat')
training_all(9, :) = training;
validation_all(9, :) = validation;

load('/home/naxos2-raid7/hongygu/non_cartesian/Paper_data/masks/mask_paper_6_10.mat')
