...
load '/home/naxos2-raid7/hongygu/non_cartesian/Paper_data/time_data/2/single_scan_2by2_sb5.mat'
traj1 = trj_kxy;
...
Npar = 24;
Ntime = 136;
img_uncombined = zeros(Ncoil,80,80, Neco);

%%
data_single_reshape = reshape(data_single, [19680/Neco, Neco, 24, Ntime, Ncoil]);
...
%    mask_2 = mask_1;
    ...
    fname = sprintf('/home/naxos2-raid7/hongygu/non_cartesian/Paper_data/fmri/3_2/slice_%d.mat', count);%+60);
