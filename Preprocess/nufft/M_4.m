...
%%
load('/home/naxos2-raid7/hongygu/non_cartesian/Paper_data/masks/mask_paper_4_1.mat')
training_all(1, :) = training;
validation_all(1, :) = validation;

load('/home/naxos2-raid7/hongygu/non_cartesian/Paper_data/masks/mask_paper_4_2.mat')
training_all(2, :) = training;
validation_all(2, :) = validation;

load('/home/naxos2-raid7/hongygu/non_cartesian/Paper_data/masks/mask_paper_4_3.mat')
training_all(3, :) = training;
validation_all(3, :) = validation;

load('/home/naxos2-raid7/hongygu/non_cartesian/Paper_data/masks/mask_paper_4_4.mat')
training_all(4, :) = training;
validation_all(4, :) = validation;

load('/home/naxos2-raid7/hongygu/non_cartesian/Paper_data/masks/mask_paper_4_5.mat')
training_all(5, :) = training;
validation_all(5, :) = validation;

load('/home/naxos2-raid7/hongygu/non_cartesian/Paper_data/masks/mask_paper_4_6.mat')
training_all(6, :) = training;
validation_all(6, :) = validation;

load('/home/naxos2-raid7/hongygu/non_cartesian/Paper_data/masks/mask_paper_4_7.mat')
training_all(7, :) = training;
validation_all(7, :) = validation;

load('/home/naxos2-raid7/hongygu/non_cartesian/Paper_data/masks/mask_paper_4_8.mat')
training_all(8, :) = training;
validation_all(8, :) = validation;

load('/home/naxos2-raid7/hongygu/non_cartesian/Paper_data/masks/mask_paper_4_9.mat')
training_all(9, :) = training;
validation_all(9, :) = validation;

load('/home/naxos2-raid7/hongygu/non_cartesian/Paper_data/masks/mask_paper_4_10.mat')
...
load('/home/naxos2-raid7/hongygu/non_cartesian/Paper_data/dcSingle_3_3_R6E10.mat')
