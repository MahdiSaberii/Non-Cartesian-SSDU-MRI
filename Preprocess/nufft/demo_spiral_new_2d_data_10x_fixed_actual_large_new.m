...
load '/home/naxos2-raid7/hongygu/non_cartesian/spiral_fmri/DCF_modified_results/my_training/ssdu_0_5/new_run/fixed_data/large_testing/fmri_1023_ISMRM.mat'
traj1 = trj_kxy;
...
%%
load ('/home/naxos2-raid7/hongygu/non_cartesian/coil_large_1023.mat')
...
%%
data_single = reshape(data_single, [2176, 6, 24, 175, Ncoil]);
...
%    mask_2 = mask_1;
    ...
    fname = sprintf('/home/naxos2-raid7/hongygu/non_cartesian/spiral_fmri/DCF_modified_results/my_training/ssdu_0_5/new_run/fixed_data/large_testing/slices/slice_%d.mat', count);%+60);
