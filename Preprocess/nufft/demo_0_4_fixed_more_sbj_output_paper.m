...
load('/home/naxos2-raid7/hongygu/non_cartesian/Paper_data/dcFull_3_3_R10E15.mat')
dcFull = permute(dcf, [3,2,1]);
%%
load ('/home/naxos2-raid7/hongygu/non_cartesian/Paper_data/3_3/R10Echo15/full_scan1_sb6.mat')
...
%% %
load ('/home/naxos2-raid7/hongygu/non_cartesian/Paper_data/3_3/R10Echo15/single_scan1_sb6.mat')
...
for ip = 1:Npar
    ...
    fname = sprintf('/home/naxos2-raid7/hongygu/non_cartesian/Paper_data/3_3_3_1/test/slice_%d.mat', count);
