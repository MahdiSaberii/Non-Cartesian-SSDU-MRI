...
%%
%load '/home/naxos2-raid7/hongygu/non_cartesian/Paper_data/2_2_single_R10E6_fmri.mat'

%%
%load '/home/naxos2-raid7/hongygu/non_cartesian/Paper_data/2_2/R6Echo5/full_scan6_sb2.mat'

%%
load '/home/naxos2-raid7/hongygu/non_cartesian/Paper_data/time_data/3/full_scan_3by3_sb3.mat'

%%
%load '/home/naxos2-raid7/hongygu/non_cartesian/Paper_data/time_data/2/full_scan_2by2_sb3.mat'

%%
%load '/home/naxos2-raid7/hongygu/non_cartesian/Paper_data/time_data/2/single_scan_2by2_sb3.mat'
...
data_full_reshaped = reshape(squeeze(data_full), [3592, Neco, R, Npar, Ncoil]);
...
for ie = 1:6
    combined(ie,:,:) = sum(img_uncombined_full(:,:,:,ie,18).*conj(squeeze(coil(:,:,18,:))), 3);
end
