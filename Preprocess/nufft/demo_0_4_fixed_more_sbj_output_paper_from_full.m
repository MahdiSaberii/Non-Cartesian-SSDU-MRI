...
%%
load ('/home/naxos2-raid7/hongygu/non_cartesian/Paper_data/2_2/R6Echo5/full_scan6_sb6.mat')
...
%% %
load ('/home/naxos2-raid7/hongygu/non_cartesian/Paper_data/2_2/R6Echo5/single_scan6_sb6.mat')

data_single = squeeze(data_full(:,1,:,:));
...
for ip = 1:Npar
    ...
    fname = sprintf('/home/naxos2-raid7/hongygu/non_cartesian/Paper_data/2_2_1/test_from_full/slice_%d.mat', count);
